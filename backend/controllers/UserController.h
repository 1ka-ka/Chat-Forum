...
public:
    ...
    ADD_METHOD_TO(UserController::getProfile, "/api/user/profile", drogon::Get, drogon::Options);
    ADD_METHOD_TO(UserController::updateProfile, "/api/user/profile", drogon::Put, drogon::Options);
